...
public class WebTestBase {
    ...
    public WebDriver getLocalDriver(String os, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (os.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "/BrowserDriver/Mac/chromedriver");//Mac doesn't need exe
    ...
    public WebDriver getCloudDriver(String envName, String os, String osVersion, String browserName, String browserVersion) throws MalformedURLException {
       ...
       // Add the following capabilities to your test script
        ...
        DesiredCapabilities capabilities = new DesiredCapabilities();//DesiredCapabilities is a class from selenium it helps us to local code to the remote driver
